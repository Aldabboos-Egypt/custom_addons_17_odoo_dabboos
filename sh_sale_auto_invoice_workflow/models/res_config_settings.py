...
class ResConfigSettings(models.TransientModel):
    ...
    group_auto_sale_workflow = fields.Boolean("Enable Auto Workflow",related = "company_id.group_auto_sale_workflow",readonly = False,implied_group='sh_sale_auto_invoice_workflow.group_auto_sale_workflow')
